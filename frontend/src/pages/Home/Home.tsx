    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4">
        <section className="py-20 text-center">
          ...
          >
            Secure Authentication <br /> Made <span className="text-primary">Simple</span>
          </motion.h1>
          <motion.p 
          ...
          >
            Protect your users and data with our state-of-the-art authentication system
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <section className="py-20">
          <h2 className="text-3xl font-bold text-center mb-12">Why Choose AuthApp?</h2>
        ...
        <section className="py-20 text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8">Join thousands of satisfied developers and businesses</p>
          <Button size="lg">
